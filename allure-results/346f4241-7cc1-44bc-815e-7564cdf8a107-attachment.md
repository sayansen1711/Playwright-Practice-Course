...
Expected: ["Samsung galaxy s6", "Nokia lumia 1520", "Nexus 6", "Samsung galaxy s7", "Iphone 6 32gb", "Sony xperia z5", "HTC One M9"]
...
> 91 |             expect(expectedProductList).toBe(actualProductList);
     |                                         ^ Error: expect(received).toBe(expected) // Object.is equality
  92 |         }
  93 |     })
  94 | })
