...
- Name: POM\POM_Test.spec.ts >> Demoblaze test >> TC-02: Duplicate SignUp
- Location: tests\POM\POM_Test.spec.ts:30:5
...
```ts
  ...
  28 |     });
  29 | 
  30 |     test('TC-02: Duplicate SignUp', async ({ page }) => {
  31 |         const signUpPage = new SignUpPage(page);
  32 |         // signedUpUser = {
  33 |         //     username: signedUpUser!.username,
  34 |         //     password: signedUpUser!.password
  35 |         // };
> 36 |         const alertMessage = await signUpPage.signUp(signedUpUser!.username, signedUpUser!.password);
     |                                                                    ^ TypeError: Cannot read properties of undefined (reading 'username')
  37 |         expect(alertMessage).toContain('This user already exist');
  38 |     });
  39 | 
